...
var SystemDataScenicFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataScenicMeta = &godbx.TableMeta[SystemDataScenic]{
    Table: "system_data_scenic",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataScenic,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataScenicDao godbx.QuickDao[SystemDataScenic] = &struct {
	godbx.QuickDao[SystemDataScenic]
}{
	godbx.NewBaseQuickDao(SystemDataScenicMeta),
}

type SystemDataScenic struct {
    Id int64
    Uuid string
    ParentId string
    Name string
