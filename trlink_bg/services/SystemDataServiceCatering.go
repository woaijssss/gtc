...
var SystemDataServiceCateringFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataServiceCateringMeta = &godbx.TableMeta[SystemDataServiceCatering]{
    Table: "system_data_service_catering",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataServiceCatering,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataServiceCateringDao godbx.QuickDao[SystemDataServiceCatering] = &struct {
	godbx.QuickDao[SystemDataServiceCatering]
}{
	godbx.NewBaseQuickDao(SystemDataServiceCateringMeta),
}

type SystemDataServiceCatering struct {
    Id int64
    Uuid string
    ParentId string
    Name string
