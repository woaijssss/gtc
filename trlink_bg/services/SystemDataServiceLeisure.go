...
var SystemDataServiceLeisureFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataServiceLeisureMeta = &godbx.TableMeta[SystemDataServiceLeisure]{
    Table: "system_data_service_leisure",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataServiceLeisure,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataServiceLeisureDao godbx.QuickDao[SystemDataServiceLeisure] = &struct {
	godbx.QuickDao[SystemDataServiceLeisure]
}{
	godbx.NewBaseQuickDao(SystemDataServiceLeisureMeta),
}

type SystemDataServiceLeisure struct {
    Id int64
    Uuid string
    ParentId string
    Name string
