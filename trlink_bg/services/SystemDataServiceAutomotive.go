...
var SystemDataServiceAutomotiveFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataServiceAutomotiveMeta = &godbx.TableMeta[SystemDataServiceAutomotive]{
    Table: "system_data_service_automotive",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataServiceAutomotive,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataServiceAutomotiveDao godbx.QuickDao[SystemDataServiceAutomotive] = &struct {
	godbx.QuickDao[SystemDataServiceAutomotive]
}{
	godbx.NewBaseQuickDao(SystemDataServiceAutomotiveMeta),
}

type SystemDataServiceAutomotive struct {
    Id int64
    Uuid string
    ParentId string
    Name string
