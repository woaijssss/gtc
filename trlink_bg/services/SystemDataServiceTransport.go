...
var SystemDataServiceTransportFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataServiceTransportMeta = &godbx.TableMeta[SystemDataServiceTransport]{
    Table: "system_data_service_transport",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataServiceTransport,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataServiceTransportDao godbx.QuickDao[SystemDataServiceTransport] = &struct {
	godbx.QuickDao[SystemDataServiceTransport]
}{
	godbx.NewBaseQuickDao(SystemDataServiceTransportMeta),
}

type SystemDataServiceTransport struct {
    Id int64
    Uuid string
    ParentId string
    Name string
