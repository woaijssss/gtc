...
var SystemDataServiceAccommodationFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataServiceAccommodationMeta = &godbx.TableMeta[SystemDataServiceAccommodation]{
    Table: "system_data_service_accommodation",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataServiceAccommodation,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataServiceAccommodationDao godbx.QuickDao[SystemDataServiceAccommodation] = &struct {
	godbx.QuickDao[SystemDataServiceAccommodation]
}{
	godbx.NewBaseQuickDao(SystemDataServiceAccommodationMeta),
}

type SystemDataServiceAccommodation struct {
    Id int64
    Uuid string
    ParentId string
    Name string
