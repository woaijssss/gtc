...
var SystemDataServiceShoppingFields = struct {
   Id string
   Uuid string
   ParentId string
   Name string
...
var  SystemDataServiceShoppingMeta = &godbx.TableMeta[SystemDataServiceShopping]{
    Table: "system_data_service_shopping",
    Columns: []string {
        "id",
        "uuid",
        "parent_id",
    ...
    AutoColumn: "id",
    LookupFieldFunc: func(columnName string,ins *SystemDataServiceShopping,point bool) any {
        if "id" == columnName {
            if point {
                 return &ins.Id
            }
...
var SystemDataServiceShoppingDao godbx.QuickDao[SystemDataServiceShopping] = &struct {
	godbx.QuickDao[SystemDataServiceShopping]
}{
	godbx.NewBaseQuickDao(SystemDataServiceShoppingMeta),
}

type SystemDataServiceShopping struct {
    Id int64
    Uuid string
    ParentId string
    Name string
